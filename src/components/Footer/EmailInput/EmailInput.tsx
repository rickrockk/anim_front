...
export const EmailInput = () => {
    return (
        ...
        />
            <svg className="email__icon" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_53_803)">
